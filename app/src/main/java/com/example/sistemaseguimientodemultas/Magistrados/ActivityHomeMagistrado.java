package com.example.sistemaseguimientodemultas.Magistrados;
...
public class ActivityHomeMagistrado extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_magistrado);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_home_magistrado, menu);
        return true;
    }
